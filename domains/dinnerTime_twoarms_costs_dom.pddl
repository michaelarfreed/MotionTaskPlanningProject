;;;remove increase total-cost 1's if time becomes an issue
...
(:functions (total-cost) - number)
 ...
 (:action pickTray
  ...
  :precondition(and (RobotAt ?lrobot) (IsTray ?tray)
		    ...
		    (IsAccessPointFor ?lrobot ?trayloc rgripper)
		    (At ?tray ?trayloc)
 ...
 (:action pickFromTray
  :parameters(?lrobot - location  ?tray - movable  ?obj - movable  ?obj2  - movable ?trayloc  - location ?gripper - manip)
 ...
 (:action putDownTray
  ...
  :precondition (and (IsTray ?tray) 
		     ...
		     (RobotAt ?lrobot) (IsAccessPointFor ?lrobot ?ltarget rgripper) 
		     )
 ...
 (:action putDown
  ...
  :precondition (and  (Object ?o1)
		     ...
		     (IsAccessPointFor ?l2 ?l1 ?gripper))

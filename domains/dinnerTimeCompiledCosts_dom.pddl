(define (domain robotics)
 ...
 (:action putDown
  ...
  (:action moveToAcrossRooms01
     :parameters(?l1 ?l2)
     :precondition (and (Location ?l1) (= ?l2 door1) (RobotAt ?l1)
     		   	(InRoom1 ?l1)
     		   	)
     :effect (and (not (RobotAt ?l1)) (RobotAt ?l2)
     	     	  )
  ...
  (:action moveToAcrossRooms4T
     :parameters(?l1 ?l2)
     :precondition (and (= ?l1 door4) (Location ?l2) (RobotAt ?l1)
     		   	(InRoom2 ?l2)
     		   	)
     :effect (and (not (RobotAt ?l1)) (RobotAt ?l2))
  )

  (:action moveToAcrossRoomsT4
     :parameters(?l1 ?l2)
     :precondition (and (= ?l2 door4) (Location ?l1) (RobotAt ?l1)
     		   	(InRoom2 ?l1)
     		   	)
     :effect (and (not (RobotAt ?l1)) (RobotAt ?l2))
  )
  ...
  (:action moveToAcrossRooms10
     :parameters(?l1 ?l2)
     :precondition (and (= ?l1 door1) (Location ?l2) (RobotAt ?l1)
     		   	(InRoom1 ?l2)
     		   	)
     :effect (and (not (RobotAt ?l1)) (RobotAt ?l2)
     	     	  )
 ...
 (:action grasp
     ...
     :effect (and (InGripper ?o1) (not (At ?o1 ?l1)) (not (empty ?gripper)) (clear ?l1)
)
 )
)

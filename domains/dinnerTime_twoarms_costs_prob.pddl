...
(:objects
	...
	trayLoc1 trayLoc2  pdp_trayLoc1 pdp_trayLoc2	
	...
	rarm_pdp_destobject11
	rarm_pdp_destobject12
	rarm_pdp_destobject21
	rarm_pdp_destobject22
	rarm_pdp_destobject13
	rarm_pdp_destobject23 - location
...
(InRoom1 pdp_trayLoc1)

(InRoom2 trayLoc2)
(InRoom2 pdp_trayLoc2)
...
(InRoom2 	rarm_pdp_destobject11)
(InRoom2 	rarm_pdp_destobject12)
(InRoom2 	rarm_pdp_destobject21)
(InRoom2 	rarm_pdp_destobject22)
(InRoom2 	rarm_pdp_destobject13)
(InRoom2 	rarm_pdp_destobject23)
...
(IsAccessPointFor pdp_trayLoc1 trayLoc1 rgripper)
(IsAccessPointFor pdp_trayLoc2 trayLoc2 rgripper)

(IsAccessPointFor rarm_pdp_destobject11 destobject11 rgripper)
(IsAccessPointFor rarm_pdp_destobject12 destobject12 rgripper)
(IsAccessPointFor rarm_pdp_destobject21 destobject21 rgripper)
(IsAccessPointFor rarm_pdp_destobject22 destobject22 rgripper)
(IsAccessPointFor rarm_pdp_destobject13 destobject13 rgripper)
(IsAccessPointFor rarm_pdp_destobject23 destobject23 rgripper)
